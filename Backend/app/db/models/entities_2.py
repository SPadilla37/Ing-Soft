...
class Usuario(Base):
    ...
    reseñas_autor = relationship("Resena", foreign_keys="Resena.autor_id", back_populates="autor")
    reseñas_receptor = relationship("Resena", foreign_keys="Resena.receptor_id", back_populates="receptor")
